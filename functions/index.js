...
const { getAllPosts, createPost, deletePost, getPost, commentOnPost, likePost, unlikePost } = require('./handlers/posts');
const { signUp, login, uploadImage, addUserInfo, getAuthUser, readNotifications, getUsersDetails } = require('./handlers/users');
...
app.get('/user/:handle', getUsersDetails);
